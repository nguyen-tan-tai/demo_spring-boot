...
public class PriceQuote extends BaseEntity {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "price_quote_seq_generator")
    @SequenceGenerator(name = "price_quote_seq_generator", sequenceName = "price_quotes_id_seq", allocationSize = 1)
    @Column(name = "pq_id")
